...
$host = 'localhost'; // Corrigido 'locaslhost' para 'localhost'
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['nota']) && isset($_POST['rastreio'])) {
        ...
        $rastreio = sanitizeInput($_POST['rastreio']);
        ...
        try {
            ...
            http_response_code(500); // Internal Server Error
            echo json_encode(array("message" => "Erro ao verificar código de rastreio: " . $e->getMessage()));
        }
    } else {
        http_response_code(400); // Bad Request
